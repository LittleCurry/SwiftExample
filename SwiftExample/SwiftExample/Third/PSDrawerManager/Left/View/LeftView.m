...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.dataArray = @[@[@"sidebar_business", @"我的商城"],
                           @[@"sidebar_purse", @"QQ钱包"],
                           @[@"sidebar_decoration", @"个性装扮"],
                           @[@"sidebar_favorit", @"我的收藏"],
                           @[@"sidebar_album", @"我的相册"],
                           @[@"sidebar_file", @"我的文件"]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.imageView.image = [UIImage imageNamed:self.dataArray[indexPath.row][0]];
...
- (UIImageView *)imageView {
    if (!_imageView) {
        ...
        _imageView.image = [UIImage imageNamed:@"sidebar_bg.jpg"];
