...
@interface DraggingViewController ()<UICollectionViewDataSource,UIGestureRecognizerDelegate,UICollectionViewDelegate,MovingDelegate>
...
- (UICollectionViewFlowLayout *)layout{
    if (!_layout) {
        _layout = [[DraggingCollectionViewLayout alloc] initWithItemsWidthBlock:^CGFloat(NSIndexPath *indexPath) {
