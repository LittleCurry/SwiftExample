...
class FirstPrintWordViewController: BaseViewController {
    ...
    func getView() -> Void {
        ...
        let myLbl = ZTypewriteEffectLabel.init(frame: CGRect(x: 5, y: 100, width: WIDTH-10, height: 450))
        myLbl.tag = 10;
        myLbl.backgroundColor = UIColor.clear
        ...
        myLbl.typewriteEffectColor = UIColor.green;
         ...
         *	1秒后开始打印输出
         */
        self.perform(#selector(FirstPrintWordViewController.startOutPut), with: nil, afterDelay: 1)
