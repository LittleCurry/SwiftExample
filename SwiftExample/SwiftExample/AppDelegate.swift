...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //热更新加载, swift 用法和oc有一定区别, 主要是在runtime上的,如何在下载完成之后刷新工程,加一个circleSlider, 增加一个通用性高的登录注册页, CAShapeLayer, CAGradientLayer, CALayer, 增加一个既能渐变色又能缩放的动画, reactNative创建一个App, JS, Shell python Ruby Perl xiaochengxu
